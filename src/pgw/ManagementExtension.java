...
public class ManagementExtension implements BerType, Serializable {
	...
	private BerOctetString information = null;
	...
	public void setInformation(BerOctetString information) {
		this.information = information;
	}

	public BerOctetString getInformation() {
		return information;
	}
	...
	public int encode(OutputStream reverseOS, boolean withTag) throws IOException {
		...
		int codeLength = 0;
		codeLength += information.encode(reverseOS, false);
		...
		codeLength += identifier.encode(reverseOS, false);
	...
	public int decode(InputStream is, boolean withTag) throws IOException {
		...
		if (berTag.equals(BerTag.CONTEXT_CLASS, BerTag.PRIMITIVE, 2)) {
			information = new BerOctetString();
			vByteCount += information.decode(is, false);
	...
	public void appendAsString(StringBuilder sb, int indentLevel) {
		...
		if (significance != null) {
			...
			sb.append("significance: <empty-required-field>");
		}
