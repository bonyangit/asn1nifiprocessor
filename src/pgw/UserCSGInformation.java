...
public class UserCSGInformation implements BerType, Serializable {
	...
	private BerOctetString cSGId = null;
	private BerInteger cSGAccessMode = null;
	...
	public void setCSGId(BerOctetString cSGId) {
		this.cSGId = cSGId;
	}

	public BerOctetString getCSGId() {
		return cSGId;
	}

	public void setCSGAccessMode(BerInteger cSGAccessMode) {
		this.cSGAccessMode = cSGAccessMode;
	}

	public BerInteger getCSGAccessMode() {
	...
	public int decode(InputStream is, boolean withTag) throws IOException {
		...
		if (berTag.equals(BerTag.CONTEXT_CLASS, BerTag.PRIMITIVE, 0)) {
			cSGId = new BerOctetString();
			vByteCount += cSGId.decode(is, false);
			vByteCount += berTag.decode(is);
		}
		else {
		...
		if (berTag.equals(BerTag.CONTEXT_CLASS, BerTag.PRIMITIVE, 1)) {
			cSGAccessMode = new BerInteger();
			vByteCount += cSGAccessMode.decode(is, false);
		...
		if (berTag.equals(BerTag.CONTEXT_CLASS, BerTag.PRIMITIVE, 2)) {
			...
			vByteCount += cSGMembershipIndication.decode(is, false);
			if (lengthVal >= 0 && vByteCount == lengthVal) {
				return tlByteCount + vByteCount;
			}
			vByteCount += berTag.decode(is);
